...
tellraw @s ["Random Block Pool region stored as (",{"score":{"name":"Global","objective":"rx1"}},", ",{"score":{"name":"Global","objective":"ry1"}},", ",{"score":{"name":"Global","objective":"rz1"}},") to (",{"score":{"name":"Global","objective":"rx2"}},", ",{"score":{"name":"Global","objective":"ry2"}},", ",{"score":{"name":"Global","objective":"rz2"}},")"]