scoreboard players operation Global rx = @e[type=area_effect_cloud,sort=random,limit=1,scores={rand_x=1..}] val
scoreboard players operation Global ry = @e[type=area_effect_cloud,sort=random,limit=1,scores={rand_y=1..}] val
scoreboard players operation Global rz = @e[type=area_effect_cloud,sort=random,limit=1,scores={rand_z=1..}] val
