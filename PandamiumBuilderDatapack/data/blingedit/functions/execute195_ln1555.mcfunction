...
execute as @e[type=magma_cube,tag=Corner] if score @s player = @e[type=player,limit=1,scores={mai_scratch0=1..}] _id run function blingedit:execute190_ln1583
execute as @s run function blingedit:get_minmax
execute as @e[type=magma_cube,tag=Corner] if score @s player = @e[type=player,limit=1,scores={mai_scratch0=1..}] _id run function blingedit:execute194_ln1594