...
tellraw @e[type=player,limit=1,scores={mai_scratch0=1..}] ["1st corner at ",[{"score":{"name":"Global","objective":"x"},"color":"red"},", ",{"score":{"name":"Global","objective":"y"}},", ",{"score":{"name":"Global","objective":"z"}}]]