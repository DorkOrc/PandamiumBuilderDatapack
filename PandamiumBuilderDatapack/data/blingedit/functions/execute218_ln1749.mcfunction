...
execute unless score @e[type=player,limit=1,scores={mai_scratch0=1..}] _id matches 0.. run scoreboard players operation @e[type=minecraft:player,limit=1,scores={mai_scratch0=1..}] _id = Global _unique
scoreboard players operation Global mai_scratch4 = @e[type=player,limit=1,scores={mai_scratch0=1..}] _id
