...
execute as @e[type=magma_cube,tag=Corner] if score @s player = Global player if score @s type matches 2..2 run function blingedit:execute028_ln287
...
scoreboard players set Global first 1
execute as @e[type=magma_cube,tag=Corner] if score @s player = Global player if score @s type matches 2..2 run function blingedit:execute030_ln302
