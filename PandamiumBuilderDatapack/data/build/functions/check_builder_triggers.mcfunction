...
execute if score <server> variable matches 1 if score @s fake_block matches 1.. at @s run function build:triggers/fake_block/check_can_fake_block
execute if score <server> variable matches 1 if score @s fake_block matches -1 at @s run function build:triggers/fake_block/kill_nearest
scoreboard players reset @s fake_block
execute if score <server> variable matches 1 run scoreboard players enable @s fake_block
