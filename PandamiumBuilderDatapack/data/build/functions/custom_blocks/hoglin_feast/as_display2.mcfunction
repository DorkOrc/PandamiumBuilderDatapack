...
data merge entity @s {CustomName:'{"text":"Dinnerbone"}',Silent:1b,NoAI:1b,IsImmuneToZombification:1b,CannotBeHunted:1b,Age:0,DeathTime:20s,Invulnerable:1b}
...
tag @s add custom_block.display_new
execute summon item_display run function build:custom_blocks/hoglin_feast/as_display3
tag @s remove custom_block.display_new