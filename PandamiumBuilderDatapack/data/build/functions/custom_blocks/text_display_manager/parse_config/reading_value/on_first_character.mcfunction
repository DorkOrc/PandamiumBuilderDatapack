...
execute if data storage build:temp {char:'l'} run function build:custom_blocks/text_display_manager/parse_config/reading_value/check_for_string/l
execute if data storage build:temp {char:'r'} run function build:custom_blocks/text_display_manager/parse_config/reading_value/check_for_string/r
