...
execute if score <found_item> variable matches 0 run tellraw @a[tag=source,limit=1] {"text":"[Custom Blocks] Invalid block state! Put a valid trapdoor block in your off-hand.","color":"red"}
