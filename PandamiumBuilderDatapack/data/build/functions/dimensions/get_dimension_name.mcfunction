...
execute if score <dim> variable matches -101 run data merge storage build:temp {Dimension:'minecraft:the_nether'}
execute if score <dim> variable matches -102 run data merge storage build:temp {Dimension:'minecraft:the_end'}
execute if score <dim> variable matches -103 run data merge storage build:temp {Dimension:'pandamium:staff_world'}
