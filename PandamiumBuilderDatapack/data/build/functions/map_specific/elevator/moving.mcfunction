...
execute align xz positioned ~ 77.8125 ~ if entity @s[tag=elevator.location.mineshaft,tag=elevator.moving_down,dx=-100] run function build:map_specific/elevator/stop
execute align xz positioned ~ 121.8125 ~ if entity @s[tag=elevator.location.mineshaft,tag=elevator.moving_up,dx=100] run function build:map_specific/elevator/stop

execute align xz positioned ~ 109.8125 ~ if entity @s[tag=elevator.location.maproom,tag=elevator.state.0,tag=elevator.moving_down,dx=-100] run function build:map_specific/elevator/stop
execute align xz positioned ~ 126.8125 ~ if entity @s[tag=elevator.location.maproom,tag=elevator.state.0,tag=elevator.moving_up,dx=100] run function build:map_specific/elevator/stop
