...
execute if score <pose> variable matches -101 store success score <value> variable store success entity @s ShowArms byte 1 unless data storage build:temp pose.nbt{ShowArms:1b}
...
execute if score <pose> variable matches -102 store success score <value> variable store success entity @s NoBasePlate byte 1 unless data storage build:temp pose.nbt{NoBasePlate:1b}
...
execute if score <pose> variable matches -103 store success score <value> variable store success entity @s NoGravity byte 1 unless data storage build:temp pose.nbt{NoGravity:1b}
...
execute if score <pose> variable matches -104 store success score <value> variable store success entity @s Small byte 1 unless data storage build:temp pose.nbt{Small:1b}
...
execute if score <pose> variable matches -105 store success score <value> variable store success entity @s CustomNameVisible byte 1 unless data storage build:temp pose.nbt{CustomNameVisible:1b}
...
execute if score <pose> variable matches -106 run function build:misc/pose/actions/toggle_invisible

execute if score <pose> variable matches -107 store success score <value> variable store success entity @s HasVisualFire byte 1 unless data storage build:temp pose.nbt{HasVisualFire:1b}
