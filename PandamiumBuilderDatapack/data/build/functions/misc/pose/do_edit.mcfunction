# Toggle NBT tags
execute if score <pose> variable matches -71 store success entity @s ShowArms byte 1 unless data storage build:pose {NBT:{ShowArms:1b}}
execute if score <pose> variable matches -72 store success entity @s NoBasePlate byte 1 unless data storage build:pose {NBT:{NoBasePlate:1b}}
execute if score <pose> variable matches -73 store success entity @s NoGravity byte 1 unless data storage build:pose {NBT:{NoGravity:1b}}
execute if score <pose> variable matches -74 store success entity @s Small byte 1 unless data storage build:pose {NBT:{Small:1b}}
execute if score <pose> variable matches -75 store success entity @s CustomNameVisible byte 1 unless data storage build:pose {NBT:{CustomNameVisible:1b}}
execute if score <pose> variable matches -76 store success entity @s Invisible byte 1 unless data storage build:pose {NBT:{Invisible:1b}}
execute if score <pose> variable matches -77 store success entity @s Marker byte 1 unless data storage build:pose {NBT:{Marker:1b}}
execute if score <pose> variable matches -77..-71 run playsound entity.armor_stand.hit master @p[tag=running_trigger]
...
execute if score <do_pose> variable matches 1 run function build:misc/pose/do_pose
execute if score <do_pose> variable matches 1 run playsound entity.armor_stand.hit master @p[tag=running_trigger]

# Mirror
execute if score <pose> variable matches -64 run function build:misc/pose/mirror
execute if score <pose> variable matches -64 run playsound entity.armor_stand.hit master @p[tag=running_trigger]
...
execute if score <pose> variable matches -65 if score <selected_item> variable matches 1 unless data storage build:pose NBT.ArmorItems[3].id run scoreboard players set <toggle_state> variable 1
execute if score <pose> variable matches -66 if score <selected_item> variable matches 1 unless data storage build:pose NBT.HandItems[1].id run scoreboard players set <toggle_state> variable 1
...
execute if score <pose> variable matches -129 run playsound block.anvil.land master @p[tag=running_trigger]

# Reset Armour Stand
execute if score <pose> variable matches -130 run data remove entity @s Pose
execute if score <pose> variable matches -130 run playsound entity.armor_stand.hit master @p[tag=running_trigger]
