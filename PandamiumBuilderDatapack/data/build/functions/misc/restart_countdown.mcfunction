...
execute if score <restart_countdown> variable matches 15 run tellraw @a {"text":"[Restart] The server will restart in 15 seconds!","color":"red"}
...
execute if score <restart_countdown> variable matches 1.. run schedule function build:misc/restart_countdown 1s
