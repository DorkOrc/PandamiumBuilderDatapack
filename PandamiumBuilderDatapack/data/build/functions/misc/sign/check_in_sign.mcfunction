...
execute store result score <in_block_y> variable run data get entity @s Pos[1] 32
...
execute if block ~ ~ ~ #standing_signs if score <in_block_x> variable matches 4..11 if score <in_block_y> variable matches 0..31 if score <in_block_z> variable matches 4..11 run scoreboard players set <in_sign> variable 1
