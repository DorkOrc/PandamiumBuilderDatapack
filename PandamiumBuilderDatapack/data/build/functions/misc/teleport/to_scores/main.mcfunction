...
execute in pandamium:staff_world as @e[type=marker,tag=teleport_marker,x=0,y=0,z=0,distance=..0.1] run function build:misc/teleport/to_scores/select_dimension
