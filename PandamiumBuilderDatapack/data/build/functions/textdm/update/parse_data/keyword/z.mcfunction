...
execute if data storage build:textdm parse_data{slice:'_translation'} store success score <continue> variable run data modify storage build:textdm parse_data.keyword set value 'z_translation'
