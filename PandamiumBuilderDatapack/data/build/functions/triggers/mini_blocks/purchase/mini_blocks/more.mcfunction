...
execute if score <value_in_section> variable matches 7 run data merge storage pandamium:temp {item:{id:'minecraft:end_crystal'}}

execute if data storage pandamium:temp item.id run function build:triggers/mini_blocks/purchase/mini_blocks/from_storage
