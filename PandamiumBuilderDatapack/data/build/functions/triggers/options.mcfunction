...
# Error Messages
execute if score @s options matches ..-1 unless score @s options matches -1 unless entity @s[scores={builder_perms=1..,options=-67..-64}] unless entity @s[scores={builder_perms=2..,options=-130}] unless entity @s[scores={can_toggle_tnt=1,options=-1001}] run tellraw @s [{"text":"[Options]","color":"dark_red"},{"text":" This is not a valid option!","color":"red"}]
