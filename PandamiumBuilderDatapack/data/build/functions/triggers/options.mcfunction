...
execute if score @s options matches 1.. if entity @s[team=builder] unless score @s sign_interaction matches 1 run tellraw @s [{"text":"Sign Interaction: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Sign Interaction\n","color":"aqua"},{"nbt":"descriptions.sign_interaction","storage":"build:options","interpret":true}]},"clickEvent":{"action":"run_command","value":"/trigger options set -64"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. if entity @s[team=builder] if score @s sign_interaction matches 1 run tellraw @s [{"text":"Sign Interaction: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Sign Interaction\n","color":"aqua"},{"nbt":"descriptions.sign_interaction","storage":"build:options","interpret":true}]},"clickEvent":{"action":"run_command","value":"/trigger options set -64"}},{"text":"True","color":"yellow","bold":true}]

execute if score @s options matches 1.. if entity @s[team=builder] unless score @s invis_indicators matches 1 run tellraw @s [{"text":"Invisible Entity Indicators: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Invisible Entity Interaction\n","color":"aqua"},{"nbt":"descriptions.invis_indicators","storage":"build:options","interpret":true}]},"clickEvent":{"action":"run_command","value":"/trigger options set -65"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. if entity @s[team=builder] if score @s invis_indicators matches 1 run tellraw @s [{"text":"Invisible Entity Indicators: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Invisible Entity Interaction\n","color":"aqua"},{"nbt":"descriptions.invis_indicators","storage":"build:options","interpret":true}]},"clickEvent":{"action":"run_command","value":"/trigger options set -65"}},{"text":"True","color":"yellow","bold":true}]
...
# Error Messages
execute if score @s options matches ..-1 unless score @s options matches -1 unless entity @s[team=builder,scores={options=-65..-64}] run tellraw @s [{"text":"[Options]","color":"dark_red"},{"text":" This is not a valid option!","color":"red"}]
