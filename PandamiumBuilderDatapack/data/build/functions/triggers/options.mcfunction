...
execute if score @s options matches 1.. if entity @s[scores={builder_perms=2..}] if score <server> variable matches 0 run tellraw @s [{"text":"Datapack Server Config: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Datapack Server Config","color":"light_purple"},{"text":"\nChanging this requires a reload.\n/reload","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -128"}},{"text":"Release","color":"yellow","bold":true}]
execute if score @s options matches 1.. if entity @s[scores={builder_perms=2..}] if score <server> variable matches 1 run tellraw @s [{"text":"Datapack Server Config: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Datapack Server Config","color":"light_purple"},{"text":"\nChanging this requires a reload.\n/reload","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -128"}},{"text":"Snapshot","color":"yellow","bold":true}]
...
execute if score @s options matches -128 if score <server> variable matches 0 run tellraw @s [{"text":"[Options]","color":"dark_red"},{"text":" Are you sure you want to switch to Snapshot? ","color":"red"},{"text":"[✔]","bold":true,"color":"dark_green","hoverEvent":{"action":"show_text","value":[{"text":"Switch Datapack Config to ","color":"dark_green"},{"text":"Snapshot","bold":true}]},"clickEvent":{"action":"run_command","value":"/trigger options set -129"}}]
execute if score @s options matches -128 if score <server> variable matches 1 run tellraw @s [{"text":"[Options]","color":"dark_red"},{"text":" Are you sure you want to switch to Release? ","color":"red"},{"text":"[✔]","bold":true,"color":"dark_green","hoverEvent":{"action":"show_text","value":[{"text":"Switch Datapack Config to ","color":"dark_green"},{"text":"Release","bold":true}]},"clickEvent":{"action":"run_command","value":"/trigger options set -129"}}]

execute if score @s options matches -129 store success score <server> variable unless score <server> variable matches 1
execute if score @s options matches -129 if score <server> variable matches 0 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"}," Changed ",{"text":"Datapack Server Config","bold":true,"color":"yellow"}," to ",{"text":"Release","color":"aqua"},"!"]
execute if score @s options matches -129 if score <server> variable matches 1 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"}," Changed ",{"text":"Datapack Server Config","bold":true,"color":"yellow"}," to ",{"text":"Snapshot","color":"aqua"},"!"]
