...
execute if score @s options matches 1.. if score @s builder_perms matches 2.. if score <server> global matches 0 run tellraw @s [{"text":"Datapack Server Config: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Datapack Server Config","color":"light_purple"},{"text":"\nChanging this requires a reload.\n/reload","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -128"}},{"text":"Release","color":"yellow","bold":true}]
execute if score @s options matches 1.. if score @s builder_perms matches 2.. if score <server> global matches 1 run tellraw @s [{"text":"Datapack Server Config: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Datapack Server Config","color":"light_purple"},{"text":"\nChanging this requires a reload.\n/reload","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -128"}},{"text":"Snapshot","color":"yellow","bold":true}]

execute if score @s options matches 1.. if score @s builder_perms matches 2.. unless score <enable_event_dimension> global matches 1 run tellraw @s [{"text":"Enable Event Dimension: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Enable Event Dimension","color":"light_purple"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -130"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. if score @s builder_perms matches 2.. if score <enable_event_dimension> global matches 1 run tellraw @s [{"text":"Enable Event Dimension: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Enable Event Dimension","color":"light_purple"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -130"}},{"text":"True","color":"yellow","bold":true}]
...
# Error Messages
execute if score @s options matches ..-1 unless score @s options matches -1 unless entity @s[scores={builder_perms=1..,options=-67..-64}] unless entity @s[scores={builder_perms=2..,options=-130..-128}] run tellraw @s [{"text":"[Options]","color":"dark_red"},{"text":" This is not a valid option!","color":"red"}]
