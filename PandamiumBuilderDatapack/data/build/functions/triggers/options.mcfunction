...
execute if score @s options matches 1.. if entity @s[scores={builder_perms=1..}] unless score @s permanent_socks matches 1 run tellraw @s [{"text":"Permanent Socks: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Permanent Socks","color":"aqua"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -66"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. if entity @s[scores={builder_perms=1..}] if score @s permanent_socks matches 1 run tellraw @s [{"text":"Permanent Socks: ","color":"aqua","hoverEvent":{"action":"show_text","value":[{"text":"Permanent Socks","color":"aqua"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -66"}},{"text":"True","color":"yellow","bold":true}]
