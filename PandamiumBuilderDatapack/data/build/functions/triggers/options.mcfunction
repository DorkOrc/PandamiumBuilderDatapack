...
execute if score @s options matches 1.. if score @s builder_perms matches 2.. unless score <enable_event_world> global matches 1 run tellraw @s [{"text":"Event World: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Event World","color":"light_purple"},{"text":"\nglobal_option","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -130"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. if score @s builder_perms matches 2.. if score <enable_event_world> global matches 1 run tellraw @s [{"text":"Event World: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Event World","color":"light_purple"},{"text":"\nglobal_option","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -130"}},{"text":"True","color":"yellow","bold":true}]

execute if score @s options matches 1.. if score @s builder_perms matches 2.. unless score <enable_blueprint_world> global matches 1 run tellraw @s [{"text":"Blueprint World: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Blueprint World","color":"light_purple"},{"text":"\nglobal_option","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -131"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. if score @s builder_perms matches 2.. if score <enable_blueprint_world> global matches 1 run tellraw @s [{"text":"Blueprint World: ","color":"light_purple","hoverEvent":{"action":"show_text","value":[{"text":"Blueprint World","color":"light_purple"},{"text":"\nglobal_option","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -131"}},{"text":"True","color":"yellow","bold":true}]

execute if score @s options matches 1.. if score @s can_toggle_tnt matches 1 unless score <enable_tnt> global matches 1 run tellraw @s [{"text":"Do TNT Explosions: ","color":"gold","hoverEvent":{"action":"show_text","value":[{"text":"Do TNT Explosions","color":"gold"},{"text":"\nglobal_option","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -1001"}},{"text":"False","color":"yellow","bold":true}]
execute if score @s options matches 1.. if score @s can_toggle_tnt matches 1 if score <enable_tnt> global matches 1 run tellraw @s [{"text":"Do TNT Explosions: ","color":"gold","hoverEvent":{"action":"show_text","value":[{"text":"Do TNT Explosions","color":"gold"},{"text":"\nglobal_option","color":"gray"}]},"clickEvent":{"action":"run_command","value":"/trigger options set -1001"}},{"text":"True","color":"yellow","bold":true}]
...
execute if score @s options matches -1 if score @s night_vis_option matches 1 run effect give @s night_vision infinite 0 true
...
execute if score @s options matches -131 store success score <enable_blueprint_world> global unless score <enable_blueprint_world> global matches 1
execute if score @s options matches -131 if score <enable_blueprint_world> global matches 0 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"},{"text":" Disabled ","color":"aqua"},{"text":"Blueprint World","bold":true,"color":"yellow"},"!"]
execute if score @s options matches -131 if score <enable_blueprint_world> global matches 0 run function build:dimensions/update_all
execute if score @s options matches -131 if score <enable_blueprint_world> global matches 1 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"},{"text":" Enabled ","color":"aqua"},{"text":"Blueprint World","bold":true,"color":"yellow"},"!"]

execute if score @s can_toggle_tnt matches 1 if score @s options matches -1001 store success score <enable_tnt> global unless score <enable_tnt> global matches 1
execute if score @s can_toggle_tnt matches 1 if score @s options matches -1001 if score <enable_tnt> global matches 0 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"},{"text":" Disabled ","color":"aqua"},{"text":"Do TNT Explosions","bold":true,"color":"yellow"},"!"]
execute if score @s can_toggle_tnt matches 1 if score @s options matches -1001 if score <enable_tnt> global matches 1 run tellraw @s [{"text":"","color":"green"},{"text":"[Options]","color":"dark_green"},{"text":" Enabled ","color":"aqua"},{"text":"Do TNT Explosions","bold":true,"color":"yellow"},"!"]

# Error Messages
execute if score @s options matches ..-1 unless score @s options matches -1 unless entity @s[scores={builder_perms=1..,options=-67..-64}] unless entity @s[scores={builder_perms=2..,options=-131..-130}] unless entity @s[scores={can_toggle_tnt=1,options=-1001}] run tellraw @s [{"text":"[Options]","color":"dark_red"},{"text":" This is not a valid option!","color":"red"}]
