...
# Snapshot
execute if score <server> global matches 1 if score @s spawn matches 1 unless score @s in_dimension matches 3 in overworld run tp @s 0 92 0 180 0
execute if score <server> global matches 1 if score @s spawn matches 1 if score @s in_dimension matches 3 in build:event_world run tp @s 0 92 0 180 0
