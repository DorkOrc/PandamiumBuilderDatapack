...
execute if entity @e[x=0,tag=selected_entity,type=armor_stand] run data merge entity @s {Marker:0b}
execute if entity @e[x=0,tag=selected_entity,type=#item_frames] run data merge entity @s {Fixed:0b}
