...
execute if score <server> variable matches 1 run tellraw @s [{"text":" Entities (ICNE): ","color":"green","hoverEvent":{"action":"show_text","value":{"text":"Entities which are not excluded from the entity-limit (snapshot server only)","color":"green"}}},{"score":{"name":"<overworld_icne_entity_count>","objective":"variable"},"bold":true,"color":"aqua"}]
...
execute unless score <server> variable matches 1 run tellraw @s [{"text":" Entities (ICNE): ","color":"#B7B7B7","hoverEvent":{"action":"show_text","value":{"text":"Entities which are not excluded from the entity-limit (snapshot server only)","color":"#B7B7B7"}}},{"score":{"name":"<overworld_icne_entity_count>","objective":"variable"},"bold":true,"color":"#C9C9C9"}]
execute unless score <server> variable matches 1 run tellraw @s [{"text":" Fake Blocks: ","color":"#B7B7B7"},{"text":"0","bold":true,"color":"#C9C9C9"}]
execute if score <server> variable matches 1 run tellraw @s [{"text":" Fake Blocks: ","color":"green"},{"score":{"name":"<overworld_fake_block_count>","objective":"variable"},"bold":true,"color":"aqua"}]
...
execute if score <server> variable matches 1 run tellraw @s [{"text":" Entities (ICNE): ","color":"green","hoverEvent":{"action":"show_text","value":{"text":"Entities which are not excluded from the entity-limit (snapshot server only)","color":"green"}}},{"score":{"name":"<nether_icne_entity_count>","objective":"variable"},"bold":true,"color":"aqua"}]
...
execute unless score <server> variable matches 1 run tellraw @s [{"text":" Entities (ICNE): ","color":"#B7B7B7","hoverEvent":{"action":"show_text","value":{"text":"Entities which are not excluded from the entity-limit (snapshot server only)","color":"#B7B7B7"}}},{"score":{"name":"<nether_icne_entity_count>","objective":"variable"},"bold":true,"color":"#C9C9C9"}]
execute unless score <server> variable matches 1 run tellraw @s [{"text":" Fake Blocks: ","color":"#B7B7B7"},{"text":"0","bold":true,"color":"#C9C9C9"}]
execute if score <server> variable matches 1 run tellraw @s [{"text":" Fake Blocks: ","color":"green"},{"score":{"name":"<nether_fake_block_count>","objective":"variable"},"bold":true,"color":"aqua"}]
