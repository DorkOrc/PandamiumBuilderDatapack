...
execute if score <log_timer> variable matches 2..7 as @a[x=-19,y=-32,z=125,dx=0,dy=0,dz=9] at @s run tp ~ ~ ~-1
execute if score <log_timer> variable matches 9..14 as @a[x=-19,y=-32,z=125,dx=0,dy=0,dz=9] at @s run tp ~ ~ ~1
