scoreboard players operation <next_checkpoint> variable = @s parkour_checkpoint
...
execute if score @s parkour_checkpoint matches 0.. if score <checkpoint_id> variable = <next_checkpoint> variable run function pandamium:misc/map_specific/parkour/new_checkpoint
