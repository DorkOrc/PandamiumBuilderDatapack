...
scoreboard players operation Global tca /= $1000 blingedit.constant
scoreboard players operation Global cor_scratch0 = Global _delta_0
scoreboard players operation Global cor_scratch0 *= Global _delta_0
...
scoreboard players operation Global delta2 /= $1000 blingedit.constant
scoreboard players operation Global tca2 = Global tca
scoreboard players operation Global tca2 *= Global tca
scoreboard players operation Global tca2 /= $1000 blingedit.constant
