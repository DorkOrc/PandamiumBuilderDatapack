...
tag @s add editor.section_colour.up
...
data modify storage build:temp transformation set value {translation:[0f,1.0001f,0.5f],scale:[8f,3.6325f,1f],left_rotation:{axis:[1f,0f,0f],angle:-1.57079632679f}}
