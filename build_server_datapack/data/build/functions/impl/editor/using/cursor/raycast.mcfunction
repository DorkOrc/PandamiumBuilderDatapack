...
execute if score $distance scratch matches 6400 run scoreboard players set $hit scratch 1

execute if score $hit scratch matches 1 run function build:impl/editor/using/cursor/teleport_cursor
