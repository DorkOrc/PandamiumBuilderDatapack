scoreboard players operation $p1x scratch = $cursor_x scratch
scoreboard players operation $p1y scratch = $cursor_y scratch
scoreboard players operation $p1z scratch = $cursor_z scratch
