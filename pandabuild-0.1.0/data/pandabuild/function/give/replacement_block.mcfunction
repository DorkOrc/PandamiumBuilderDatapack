...
# get item
$execute in pandabuild:storage run item replace block 0 1 0 container.0 with pig_spawn_egg[entity_data={id:"minecraft:marker"},custom_data={pandabuild:{id:"replacement_block",replacement_block:{args:{block:"$(block)"}}}},rarity="epic",item_model="minecraft:light",enchantment_glint_override=true,item_name=["",{bold:true,text:"Places"},": ","Unknown"]]
