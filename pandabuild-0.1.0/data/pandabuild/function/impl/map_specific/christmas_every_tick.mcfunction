...
# rtp portal effect
particle minecraft:tinted_leaves{color:[0,0.8,0.4,1]} -288.5 130.5 183.5 1.5 1.5 0.1 0.5 1 force
particle minecraft:trail{color:[1,1,1],duration:400,target:[-288,100,183]} -288.5 131 183.5 1.5 1.5 0.1 0 1
