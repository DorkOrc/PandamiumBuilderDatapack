...
execute if score @s spawn.snapshot.variant_1.overworld matches 1.. in pandabuild:servers/snapshot/variant_1/overworld run tp @s -289 127 174 0 0
execute if score @s spawn.snapshot.variant_1.the_nether matches 1.. in pandabuild:servers/snapshot/variant_1/the_nether run tp @s 0 128 0 180 0
